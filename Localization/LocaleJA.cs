            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PO_GetLocalMail)),
                    "市内郵便の残量が設定値以下になったときに指定した量の市内郵便を取得する機能を有効にします。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PO_GettingThresholdPercentage)),
                    "市内郵便の残量が郵便局の容量のこのパーセンテージ以下になったときに市内郵便を取得します。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PO_GettingPercentage)),
                    "市内郵便を受け取る量を郵便局の容量のパーセンテージで指定します。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PO_DisposeOverflow)),
                    "郵便物の残量が設定値以上になったときにそれ以上を廃棄する機能を有効にします。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PO_OverflowPercentage)),
                    "郵便物の残量が郵便局の容量のこのパーセンテージ以上になったときに溢れた分の郵便物を廃棄します。" },

                // NEW: FixMailOverflow
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FixMailOverflow)),
                    "郵便物の溢れを修正する" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.FixMailOverflow)),
                    "郵便局の郵便物が満杯になると配達バンが出発しなくなる場合があります。"
                  + "このオプションを有効にすると、溜まりすぎた郵便物を定期的に削減し、この問題を軽減します。" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PSF_GetUnsortedMail)),
                    "未分類郵便の残量が設定値以下になったときに指定した量の未分類郵便を取得する機能を有効にします。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PSF_GettingThresholdPercentage)),
                    "未分類郵便の残量が郵便物仕分け施設の容量のこのパーセンテージ以下になったときに未分類郵便を取得します。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PSF_GettingPercentage)),
                    "未分類郵便を受け取る量を郵便物仕分け施設の容量のパーセンテージで指定します。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PSF_DisposeOverflow)),
                    "郵便物の残量が設定値以上になったときにそれ以上を廃棄する機能を有効にします。" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PSF_OverflowPercentage)),
                    "郵便物の残量が郵便物仕分け施設の容量のこのパーセンテージ以上になったときに溢れた分の郵便物を廃棄します。" },
